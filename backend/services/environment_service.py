...
class EnvironmentService:
    ...
    async def get_all_data(self, page:int = 1, limit: int = 25) -> list[EnvironmentOut]:
    ...
    async def get_specific_data(self, data_type: str, page:int = 1, limit: int = 25) -> list[EnvironmentOut]:
